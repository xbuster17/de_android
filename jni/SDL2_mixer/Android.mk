...
FLAC_LIBRARY_PATH := external/flac-1.2.1/src/libFLAC
LOCAL_C_INCLUDES += $(LOCAL_PATH)/external/flac-1.2.1/include $(LOCAL_PATH)/external/flac-1.2.1 $(LOCAL_PATH)/$(FLAC_LIBRARY_PATH)/include
...
LOCAL_SRC_FILES += \
	$(subst $(LOCAL_PATH)/,, \
	$(wildcard $(LOCAL_PATH)/$(FLAC_LIBRARY_PATH)/*.c))
